...
CREATE TABLE public.cd_cohort_overlap (
  	 either_subjects NUMERIC,
	 both_subjects NUMERIC,
	 t_only_subjects NUMERIC,
	 c_only_subjects NUMERIC,
	 t_before_c_subjects NUMERIC,
	 c_before_t_subjects NUMERIC,
	 same_day_subjects NUMERIC,
	 t_in_c_subjects NUMERIC,
	 c_in_t_subjects NUMERIC,
