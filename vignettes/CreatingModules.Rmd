...
fs::dir_tree(file.path(getwd(), "extras/module_skeleton"), recurse = FALSE, type = "file")
```
...
```{r comment='', echo=FALSE}
cat(readLines(file.path(getwd(), "extras/module_skeleton/MetaData.json")), sep = '\n')
```
...
```{r comment='', echo=FALSE}
cat(readLines(file.path(getwd(), "extras/module_skeleton/Main.R")), sep = '\n')
```
...
```{r comment='', echo=FALSE}
cat(readLines(file.path(getwd(), "extras/module_skeleton/resources/resultsDataModelSpecification.csv")), sep = '\n')
```
...
```{r comment='', echo=FALSE}
cat(readLines(file.path(getwd(), "extras/module_skeleton/SettingsFunctions.R")), sep = '\n')
```
...
```{r comment='', echo=FALSE}
cat(readLines(file.path(getwd(), "extras/module_skeleton/resources/exampleAnalysisSpecifications.json")), sep = '\n')
```
...
```{r comment='', echo=FALSE}
cat(readLines(file.path(getwd(), "extras/module_skeleton/extras/ModuleMaintenance.R")), sep = '\n')
```
## Test Files
